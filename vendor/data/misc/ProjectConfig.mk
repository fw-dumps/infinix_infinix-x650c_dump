...
AUTO_ADD_GLOBAL_DEFINE_BY_VALUE = CUSTOM_TRAN_PROJECT CUSTOM_TRAN_BOM CUSTOM_TRAN_PCBA CUSTOM_TRAN_CAM_MATERIAL_CODE CUSTOM_HAL_LENS BOOT_LOGO MTK_AUDIO_BLOUD_CUSTOMPARAMETER_REV MTK_PLATFORM CUSTOM_KERNEL_LENS CUSTOM_KERNEL_MAIN_BACKUP_LENS MTK_MODEM_SUPPORT CUSTOM_KERNEL_MAIN_IMGSENSOR MTK_BT_CHIP MTK_WLAN_CHIP CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR CUSTOM_KERNEL_FLASHLIGHT CUSTOM_KERNEL_SUB_IMGSENSOR CUSTOM_KERNEL_SUB_LENS CUSTOM_KERNEL_IMGSENSOR MTK_FM_RX_AUDIO MTK_COMBO_CHIP MTK_GPS_CHIP CUSTOM_KERNEL_SUB_BACKUP_LENS CUSTOM_KERNEL_MAIN_LENS MTK_FM_CHIP CUSTOM_KERNEL_MAIN2_IMGSENSOR BOOT_LOGO
#BSP:modify XLWLCHLEL-8 by zhijun.ye 20190507 start
BOOT_LOGO = hdplus1600
#BSP:modify XLWLCHLEL-8 by zhijun.ye 20190507 end
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
...
CUSTOM_BUILD_VERNO = CY-X650C-H626-D
...
#ITD:Modify Camera BringUp By Jesse 0507 Start
CUSTOM_TRAN_PCBA = tran_pcba_h626
CUSTOM_HAL_FLASHLIGHT = dummy_flashlight
CUSTOM_HAL_IMGSENSOR = gc8034_mipi_raw s5k3l6_mipi_raw sp250a_mipi_raw gc6153_serial_yuv pblcgc8034_mipi_raw pblcs5k3l6_mipi_raw pblcsp250a_mipi_raw pblcgc6153_serial_yuv
CUSTOM_TRAN_CAM_MATERIAL_CODE = gc8034_17201572 s5k3l6_17201563 sp250a_17201564 gc6153_17201581
...
#ITD:Modify Camera BringUp By Jesse 0507 End
...
#BSP: modify XLWLCHLEL-50 by tao.lan 20190529 start
CUSTOM_KERNEL_BAROMETER = no
#BSP: modify XLWLCHLEL-50 by tao.lan 20190529 end
...
#ITD:Modify Camera BringUp By Jesse 0507 Start
CUSTOM_KERNEL_IMGSENSOR = gc8034_mipi_raw s5k3l6_mipi_raw sp250a_mipi_raw gc6153_serial_yuv
...
#TSD: modify CCQHLEL-2 by chaochao.he 20190508 start
CUSTOM_MODEM= x650c_h626_d1
#TSD: modify CCQHLEL-2 by chaochao.he 20190508 end
...
#BSP:modify XLWLCHLEL-4 by shuanglei.wang 20190506 start
MTK_AUDIO_NUMBER_OF_MIC = 1
#BSP:modify XLWLCHLEL-4 by shuanglei.wang 20190506 end
...
#SID: add XLWLBHLYYL-29 lijia.chen 20190520 start
MTK_BUILD_VERNO=X650C-H626DE-P-190807V174
FINGERPRINT_BUILD_VERNO=DE-190807V174
#SID: add XLWLBHLYYL-29 lijia.chen 20190520 end
MTK_BWC_SUPPORT = yes
#TSD: modify CCQHLEL-2 by chaochao.he 20190508 start
MTK_C2K_LTE_MODE = 0
#TSD: modify CCQHLEL-2 by chaochao.he 20190508 en
...
#ITD:add for CAM_SKIN_COMPATIBLE by xugao at 20190619 start
TRAN_CAM_SKIN_COMPATIBLE = yes
#ITD:add for CAM_SKIN_COMPATIBLE by xugao at 20190619 end
...
#BSP:modify XLWLCHLEL-5 by fan.hong 20190506 start
MTK_DUAL_CHARGER_SUPPORT = no
#BSP:modify XLWLCHLEL-5 by fan.hong 20190506 end
...
# BSP: Modify XLWLCHLEL-10 by fengshan.wang 20190508 start
MTK_FACTORY_MODE_IN_GB2312 = no
# BSP: Modify XLWLCHLEL-10 by fengshan.wang 20190508 end
...
#SID: add XLELHLES-12 lijia.chen 20181106 start
MTK_LOG_CUSTOMER_SUPPORT = yes
#SID: add XLELHLES-12 lijia.chen 20181106 end
...
#BSP: modify for XLELHLES-7 by shentao.yang start
#BSP: modify for XLELHLES-7 by shentao.yang end
...
MTK_TOUCH_BOOST = no
MTK_TTY_SUPPORT = yes
# BSP:Add XLWLCHLEL-67 by cheng.chen3 20190523 start
MTK_UART_USB_SWITCH = yes
# BSP:Add XLWLCHLEL-67 by cheng.chen3 20190523 end
MTK_UCE_SUPPORT = no
MTK_UFS_OTP = no
...
#BSP: add KCSGHLYYL-22 by yong.jiang 20190329 start
TRAN_FINGERPRINT_SUPPORT = sunwave_tee chipone_tee
#BSP: add KCSGHLYYL-22 by yong.jiang 20190329 end
...
CUSTOM_TRAN_PROJECT=tran_x650c
CUSTOM_TRAN_BOM=tran_x650c_d1
...
#BSP:add XLWLCHLEL-764 by shuanglei.wang 20190627 start
TRAN_AUDIOTEST_SUPPORT = yes
TRAN_NEW_LOOPBACK_TEST = yes
TRAN_VOIP_BYPASS_DIRAC = yes
#BSP:add XLWLCHLEL-764 by shuanglei.wang 20190627 end
#BSP:add XLWLCHLEHW-12 by yong.guo 20190520 start
TRAN_DIRAC_PROP_SUPPORT = yes
#BSP:add XLWLCHLEHW-12 by yong.guo 20190520 end
# BSP: add XLWLCHLEL-10 by fengshan.wang 20190513 start
TRAN_FT_RESET = yes
TRAN_FT_REBOOT = yes
...
# BSP: add XLWLCHLEL-10 by fengshan.wang 20190513 end

#BSP: add CCQHLEL-3 by qiuwei.wang 20190520 start
TRAN_TP_SUPPORT = yes
#BSP: add CCQHLEL-3 by qiuwei.wang 20190520 end
#ITD:add cam 3pty function XWWYLHLYS-302 by xiaoxue.cai 20190522 start
TRAN_CAMERA_FEATURE = yes
#ITD:add cam 3pty function XWWYLHLYS-302 by xiaoxue.cai 20190522 end
#ITD:add cam dualcam_fullsize XLWLCHLEL-150 by yu.wang 20190611 start
TRAN_DUALCAM_PICTURESIZE_EXTEND = yes
#ITD:add cam dualcam_fullsize XLWLCHLEL-150 by yu.wang 20190611 end
